...
df <- 
  read_csv("https://klh281.github.io/UseR2025/data/uncertainty_exp2.csv") |> 
...
Notice that the data frame now has the "real condition" ([graph_type]{.variable-name}) and a randomly shuffled condition ([shuffled_group]{.variable-name}).
